...
var require_lodash2 = __commonJS((exports, module) => {
  ...
  function equalArrays2(array, other, bitmask, customizer, equalFunc, stack) {
    ...
    var index = -1, result = true, seen = bitmask & COMPARE_UNORDERED_FLAG3 ? new SetCache2 : undefined;
...
var _ParentBlot = class _ParentBlot2 extends ShadowBlot {
  ...
  split(index, force = false) {
    ...
    return this.parent && this.parent.insertBefore(after, this.next || undefined), this.children.forEachAt(index, this.length(), (child, offset, _length) => {
...
class Inline extends InlineBlot$1 {
  static allowedChildren = [Inline, break_default, EmbedBlot$1, Text2];
  static order = [
    "cursor",
    "inline",
    "link",
...
function shiftRange2(range, index, lengthOrSource, source) {
  ...
  if (index && typeof index.transformPosition === "function") {
    [start, end] = [range.index, range.index + range.length].map((pos) => index.transformPosition(pos, source !== emitter_default.sources.USER));
  } else {
...
class History extends module_default {
  static DEFAULTS = {
    delay: 1000,
    maxStack: 100,
    userOnly: false
...
class RichTextConverterApp {
  ...
  initializeElements() {
    ...
    if (!this.outputElement || !this.outputCodeElement || !this.convertButton || !this.clearButton || !this.sampleButton || !this.copyButton) {
      throw new Error("Required DOM elements not found");
    }
  }
  initializeEditor() {
    try {
      this.editor = new quill_default("#input-text", {
        theme: "snow",
        modules: {
          toolbar: [
            [{ header: [1, 2, 3, false] }],
